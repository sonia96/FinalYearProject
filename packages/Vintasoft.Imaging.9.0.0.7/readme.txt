...
The SDK contains WinForms, WPF and HTML5 and SVG controls for viewing, printing and editing images.

GENERAL FEATURES:
- SDK can be used for developing .NET Core 3 applications (console, ASP.NET Core, service, etc) for Windows
...
- Windows (Windows 10/8.1/8/7; Windows Server 2019/2016/2012/2008; 32-bit and 64-bit) and .NET Core 3
...
6. Articles:
- View images in WinForms: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-View-View_Images_in_WinForms.html?referer=nuget.org/Vintasoft.Imaging
- View thumbnails in WinForms: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-View-View_Thumbnails_in_WinForms.html?referer=nuget.org/Vintasoft.Imaging
- Visual tools for WinForms image viewer: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-Visual_Tools-Visual_Tools_For_WinForms_Image_Viewer.html?referer=nuget.org/Vintasoft.Imaging
- Print images in WinForms: https://www.vintasoft.com/docs/vsimaging-dotnet/Programming-Print_Images_In_WinForms.html?referer=nuget.org/Vintasoft.Imaging
